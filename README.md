# Chinese New Year 春節 — Community Archive & Advocacy

A community-driven website that:

1. **Documents** how companies and institutions refer to Chinese New Year
2. **Explains** why the historically accurate name "Chinese New Year" (春節) matters
...
We welcome contributions! Whether you want to add a company entry or improve the content, see **[CONTRIBUTING.md](CONTRIBUTING.md)** for a step-by-step guide designed for non-technical contributors.
...
```
cnylny/
├── index.html          # Main website (single-page app with two tabs)
├── style.css           # Dark red & gold theme
├── script.js           # Tab switching and data rendering
├── data/
│   ├── cny.json        # Companies using "Chinese New Year" ✅
│   └── lny.json        # Companies using "Lunar New Year" ❌
├── screenshots/        # Screenshot images of company pages
├── CONTRIBUTING.md     # Guide for contributors
├── README.md           # This file
└── CNY_LNY.txt         # Reference materials
```
